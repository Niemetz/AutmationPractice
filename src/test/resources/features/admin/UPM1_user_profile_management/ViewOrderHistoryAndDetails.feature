# Author: John Nguyen
#############################################
# Epic Requirement ID  = UPM_1 (JiraID = ARM-10)  -> User Profile Management 
# Story Requirement ID = UPM_1.1 (JirasID = ARM-18) -> View Order History And Details 
# Acceptance Criteria :
...
#  I want to see this message in GitHub

# Want to see this in GitHub
@Test_Cycle:Regression_Release_1.0_RC_1.0 
@version:Build_Release_1.0_RC_1.0
Feature: UPM_1.1 -> View order history and details. 
